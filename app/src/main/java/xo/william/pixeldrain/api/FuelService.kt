...
class FuelService() {
    ...
    fun setThumbnail(_infoFiles: MutableLiveData<MutableList<InfoModel>>, id: String){
        val url = "$baseUri/file$id/thumbnail"
    ...
    fun setInfoData2(_infoFiles: MutableLiveData<MutableList<InfoModel>>, id: String) {
